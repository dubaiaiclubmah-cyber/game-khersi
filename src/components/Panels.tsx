      ...
      <div className="mt-4">
        ...
        <div className="mt-2 flex h-12 items-end gap-1">
          {Array.from({ length: 8 }).map((_, i) => {
            ...
            if (v === undefined) {
              return <span key={i} className="h-[3px] flex-1 bg-[#12281d]" />;
            }
            ...
            return (
              <span
                ...
                style={{
                  ...
                  background: isLast ? "#ffc94d" : "#3f7a5c",
  ...
  return (
    <div
      ...
      className={
        ...
        (unlocked
          ? "border-amber/70 bg-[#2a2110] shadow-[0_0_16px_rgba(255,201,77,0.18)] hover:-translate-y-0.5 hover:shadow-[0_0_22px_rgba(255,201,77,0.32)]"
          : "border-hedge bg-[#0a1712] hover:border-mint/40")
      }
    >
